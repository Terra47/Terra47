...
print(f"Status: {terra.status_atual()}")
```
...
<div align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=Terra47&theme=gruvbox&bg_color=2d2d2d&color=cd853f&line=8b4513&point=ebdbb2&area=true&hide_border=true" />
</div>
...
projetos.forEach(p => console.log(`${p.nome}: ${p.descrição} - ${p.status}`));
```
...
<details>
<summary><strong>🎮 Estilo de vida</strong></summary>
<br>
...
class Rotina:
    ...
    def equilibrio(self):
        return "Tudo na medida certa"

vida = Rotina()
print(f"Manhã: {vida.manha}")
print(f"Noite: {vida.noite}")
```
...
## 🎵 Música enquanto codifico

<div align="center">

[![Spotify](https://img.shields.io/badge/Spotify-8B4513?style=for-the-badge&logo=spotify&logoColor=white&labelColor=CD853F)](https://open.spotify.com/user/terra)
...
```
  ...
  <br>
  <sub>📬 Só chamar no Discord: 0.997</sub>
  <br><br>
  <img src="https://komarev.com/ghpvc/?username=Terra47&color=8B4513&style=flat-square&label=visitantes" />
</div>
